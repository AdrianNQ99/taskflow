        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                    ...
                    <div key={label} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 flex items-start gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                    ...
                    {showForm && (
                        <form onSubmit={handleCreateProject} className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 space-y-3">
                            <input
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
                        {loading ? (
                            ...
                            projects.slice(0, 5).map((p) => (
                                <div key={p.id} className="flex items-center justify-between px-6 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    <button
